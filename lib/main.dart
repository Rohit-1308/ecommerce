  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            Image(image: AssetImage('images/signin.png'),height: 250,),
            SizedBox(height: 20,),
            Text('Login',style: TextStyle(color: Color(0xFF4C53A5),fontSize: 20,fontWeight: FontWeight.bold),textAlign: TextAlign.center,),
            SizedBox(height: 20,),
            Padding(
                    ...
                    Container( height: 48,
                      child: Align( alignment: Alignment.centerRight,
                        child: GestureDetector(
                          ...
                          child: Text('Forgot?',style: TextStyle(color: Color(0xFF4C53A5),),),
                        ),
                      ),
                    )
                  ]
            ...
            Padding(
              ...
              child: MaterialButton( color: Color(0xFF4C53A5),padding: EdgeInsets.all(10),
                onPressed: (){
            ...
            Text.rich(TextSpan(text: "Don't have an account yet?",
                children:[
                  TextSpan(text: " SignUp",style: TextStyle(color: Color(0xFF4C53A5),fontWeight: FontWeight.bold,fontSize: 20),
