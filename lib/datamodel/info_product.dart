...
class InfoProduct {
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [InfoProduct].
  factory InfoProduct.fromJson(String data) {
    return InfoProduct.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [InfoProduct] to a JSON string.
  String toJson() => json.encode(toMap());

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    if (other is! InfoProduct) return false;
